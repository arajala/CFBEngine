...
%             trainData(1,32) = theseStats(iTeam2,3);
        ...
        case 'FumblesLost'
            trainData(1,77) = theseStats(iTeam1,2) / theseStats(iTeam1,1);
            trainData(1,78) = theseStats(iTeam2,2) / theseStats(iTeam2,1);
        case 'FumblesRecovered'
            trainData(1,79) = theseStats(iTeam1,2) / theseStats(iTeam1,1);
            trainData(1,80) = theseStats(iTeam2,2) / theseStats(iTeam2,1);
        ...
        case 'NetPunting'
            ...
            trainData(1,100) = theseStats(iTeam1,5) / theseStats(iTeam1,4);
            ...
            trainData(1,105) = theseStats(iTeam2,5) / theseStats(iTeam2,4);
            trainData(1,106) = theseStats(iTeam2,6);
        case 'PassesHadIntercepted'
            trainData(1,107) = theseStats(iTeam1,3) / theseStats(iTeam1,2);
            trainData(1,108) = theseStats(iTeam2,3) / theseStats(iTeam2,2);
        ...
        case 'PassesIntercepted'
            trainData(1,111) = theseStats(iTeam1,3) / theseStats(iTeam1,2);
            trainData(1,112) = theseStats(iTeam2,3) / theseStats(iTeam2,2);
        ...
        case 'PassingOffense'
            ...
            trainData(1,121) = theseStats(iTeam1,4) / theseStats(iTeam1,2);
            ...
            trainData(1,129) = theseStats(iTeam2,4) / theseStats(iTeam2,2);
        ...
        case 'RedZoneDefense'
            ...
            trainData(1,174) = theseStats(iTeam1,3) / theseStats(iTeam1,2);
            trainData(1,175) = theseStats(iTeam1,4) / theseStats(iTeam1,2);
            trainData(1,176) = theseStats(iTeam1,5) / theseStats(iTeam1,2);
            trainData(1,177) = theseStats(iTeam1,6) / theseStats(iTeam1,2);
            trainData(1,178) = theseStats(iTeam1,7);
            trainData(1,179) = theseStats(iTeam2,2) / theseStats(iTeam2,1);
            trainData(1,180) = theseStats(iTeam2,3) / theseStats(iTeam2,2);
            trainData(1,181) = theseStats(iTeam2,4) / theseStats(iTeam2,2);
            trainData(1,182) = theseStats(iTeam2,5) / theseStats(iTeam2,2);
            trainData(1,183) = theseStats(iTeam2,6) / theseStats(iTeam2,2);
            trainData(1,184) = theseStats(iTeam2,7);
        case 'RedZoneOffense'
            trainData(1,185) = theseStats(iTeam1,2) / theseStats(iTeam1,1);
            trainData(1,186) = theseStats(iTeam1,3) / theseStats(iTeam1,2);
            trainData(1,187) = theseStats(iTeam1,4) / theseStats(iTeam1,2);
            trainData(1,188) = theseStats(iTeam1,5) / theseStats(iTeam1,2);
            trainData(1,189) = theseStats(iTeam1,6) / theseStats(iTeam1,2);
            trainData(1,190) = theseStats(iTeam1,7);
            trainData(1,191) = theseStats(iTeam2,2) / theseStats(iTeam2,1);
            trainData(1,192) = theseStats(iTeam2,3) / theseStats(iTeam2,2);
            trainData(1,193) = theseStats(iTeam2,4) / theseStats(iTeam2,2);
            trainData(1,194) = theseStats(iTeam2,5) / theseStats(iTeam2,2);
            trainData(1,195) = theseStats(iTeam2,6) / theseStats(iTeam2,2);
        ...
        case 'TacklesForLossAllowed'
            ...
            trainData(1,262) = theseStats(iTeam2,4) / theseStats(iTeam2,1);
        ...
        case 'TotalDefense'
            ...
            trainData(1,312) = theseStats(iTeam1,5) / theseStats(iTeam1,1);
            trainData(1,313) = theseStats(iTeam1,6) / theseStats(iTeam1,1);
            ...
            trainData(1,318) = theseStats(iTeam2,5) / theseStats(iTeam2,1);
            trainData(1,319) = theseStats(iTeam2,6) / theseStats(iTeam2,1);
        ...
        case 'TotalOffense'
            ...
            trainData(1,324) = theseStats(iTeam1,5) / theseStats(iTeam1,1);
            trainData(1,325) = theseStats(iTeam1,6) / theseStats(iTeam1,1);
            ...
            trainData(1,330) = theseStats(iTeam2,5) / theseStats(iTeam2,1);
            trainData(1,331) = theseStats(iTeam2,6) / theseStats(iTeam2,1);
        ...
        case 'TurnoverMargin'
            ...
            trainData(1,339) = theseStats(iTeam1,8) / theseStats(iTeam1,1);
            ...
            trainData(1,347) = theseStats(iTeam1,8) / theseStats(iTeam2,1);
